...
# Predicción de un nuevo resultado (Ejemplo: varianza 0.062525 y oblicuidad 2.9301)
resultado = classifier.predict(sc.transform([[0.062525, 2.9301]]))  
print(f"Predicción para varianza 0.062525 y oblicuidad 2.9301: {resultado}")
